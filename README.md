# Creating SciENcv generated NIH/NSF biosketch 
Moo K. Chung, March 2, 2025;  October 26, 2025
...
1a) Alternatly,  login into SciENcv using NIH eRA Commons credentials or NSF credentials
https://www.ncbi.nlm.nih.gov/sciencv/

2) Then you need to generate a new document using the NIH Biosketch format. 
...
3) Generate PDF (by clicking DOWNLOAD button), which will have some sort of digitial mark embeded in PDF.
